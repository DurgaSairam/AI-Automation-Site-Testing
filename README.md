...
### 2. Configure Your Test URL

**For Staging (Recommended First):**
```bash
export TEST_URL=https://mcstaging.fantasyworldtoys.com
npm test
```

**Or use the convenient staging script:**
```bash
...
- Open `auto-test-suite.js`
- Change the `baseUrl` on line ~13 to your URL
